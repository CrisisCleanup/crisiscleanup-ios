...
final class NetworkIncidentTests: XCTestCase {
    private let expectedIncidents = [
        fillNetworkIncident(
            ...
            "Small Tornado (Fake)", "chippewa_dunn_wi_tornado", "A", "tornado",
            [NetworkIncidentLocation(129, 41905)]
        ),
        fillNetworkIncident(
            200, "2022-07-20T16:28:51Z",
            "Another Tornado (Fake)", "another_tornado", "B", "tornado",
            [
        ...
        fillNetworkIncident(
            ...
            "Pandemic (Fake)", "covid_19_response", "C", "virus",
        ...
        fillNetworkIncident(
            ...
            "Medium Storm (Fake)", "n_wi_derecho_jul_2019", "fg", "wind",
